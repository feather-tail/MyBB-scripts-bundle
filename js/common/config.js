(() => {
  ...
  window.ScriptConfig = {
    ...
    balanceTool: {
      ...
      access: { allowedTopicIds: ['155', '233', '318', '393', '503', '624', '663'], allowedGroupIds: [1, 2] },
...
[align=center]&#10070; авторский мир    &#10070; мистика    &#10070; академия      &#10070; рисованные внешности  &#10070; 18+[/align]`,
    ...
    prQuickLogin: {
      login: 'PR',
      pass: '1111',
      redirectUrl: 'https://kindredspirits.ru/viewtopic.php?id=666',
      selectors: {
        btn: '#pr-quick-login',
        navLogin: '#navlogin',
    ...
    themeSwitcher: {
      storage: { key: 'mybb.display.v1', instance: 'spring2025' },
      defaults: { style: 'spring', scheme: 'light', view: 'desktop' },
      styles: [
